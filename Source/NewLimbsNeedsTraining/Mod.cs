...
namespace NewLimbsNeedsTraining
{
    ...
    internal class NewLimbsNeedsTrainingMod : Mod
    {
        ...
        {
            var ticksUntilDone = OneDayInTicks * DaysUntilRecovery[TechLevel.Industrial];
            ...
            ticksUntilDone = OneDayInTicks * DaysUntilRecovery[part.def.spawnThingOnRemoved.techLevel];
            //Log.Message(
